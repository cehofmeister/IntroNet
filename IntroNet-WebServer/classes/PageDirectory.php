...
class PageDirectory {
    ...
    private static $directory = array(
        ...
        "ControlPanel" =>   array("class" => "ControlPanelPage", "file" => "ControlPanelPage.php"),
        ...
        "Customize" =>      array("class" => "CustomizeParticipantsSchedule", "file" => "CustomizeParticipantsSchedule.php"),
        "insertParticipant" => array("class" => "InsertParticipant", "file" => "InsertParticipant.php"),
        "Mypage" =>         array("class" => "MyPage", "file" => "MyPage.php"),
        "organizeTable" =>  array("class" => "OrganizeTable", "file" => "OrganizeTable.php"),
